...
SCounterDefinition CounterDefinitions[] = {
    ...
    {504, S_ID3,  INTEL_HASW, 0,  3,     0,   0xc4,     0x00,  "AllBrR"  },
    {505, S_ID3,  INTEL_HASW, 0,  3,     0,   0xc4,     0x01,  "CondBrR"  },
    {506, S_ID3,  INTEL_HASW, 0,  3,     0,   0xc4,     0x10,  "NotTknBrR"  },
    {507, S_ID3,  INTEL_HASW, 0,  3,     0,   0xc5,     0x01,  "MispCond"  },
    {508, S_ID3,  INTEL_HASW, 0,  3,     0,   0xc5,     0x04,  "MispMacro"  },
    {509, S_ID3,  INTEL_HASW, 0,  3,     0,   0x88,     0x41,  "NTknBrExe"  },
    {510, S_ID3,  INTEL_HASW, 0,  3,     0,   0x88,     0x81,  "TknBrExe"  },
