...
def btb_test(nums, aligns, name):
    ...
    for align in aligns:
        ...
        for num in nums:
            ...
            print("Number of total branches:", res['totBr'] / 100 -1)
...
def add_tests(agner):
    ...
    add_test(agner, [6], [2**x for x in range(15, 16)], "test: J1, J2, J3, J4, J5, J1, J2, J3, J4, J5")
    # for LRU: expect 6 resteers
    # for FIFO: expect 6 resteers
    # for LIFO: expect 3 resteers
